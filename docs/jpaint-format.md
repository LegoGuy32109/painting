...
| `title`                                                        | Yes                       | Direct.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `author`                                                       | Yes                       | Direct — the owning profile's CURRENT handle, joined at read time off `canvases.owner_id` (see `getCompletedCanvas()` in `src/server/db.ts`), so a later handle rename is reflected immediately rather than frozen at signing time.                                                                                                                                                                                                                                                                                          |
